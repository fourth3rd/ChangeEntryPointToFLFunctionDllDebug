...
int main()
{
	FILE* fp = fopen("DllEntryPointToFLFunctionOriginal.dll", "rb");
	...
	if(fp)
	{
		...
		fclose(fp);
		fp = fopen(R"(DllEntryPointToFLFunction.dll)", "wb");
		fseek(fp, 0, SEEK_SET);
